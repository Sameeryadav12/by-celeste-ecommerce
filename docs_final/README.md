...
Plain-language notes for **By Celeste** — behaviour, architecture, and operations.
...
| [04-products.md](./04-products.md) | Catalog model |
...
| [12-square-payment-flow.md](./12-square-payment-flow.md) | Square |
| [13-customer-dashboard.md](./13-customer-dashboard.md) | Account area |
